        ...
        <div className="grid gap-10 md:grid-cols-3">
          ...
          <div>
            ...
            <ul className="mt-5 space-y-3 text-sm">
              <li className="flex items-center gap-3"><span>📍</span> 2rd floor Awfis work space, Kudlu Gate, Hosur Rd, Bengaluru, Karnataka 560068</li>
              <li className="flex items-center gap-3"><span>✉️</span> hr@mybankauction.com</li>
              <li className="flex items-center gap-3"><span>📞</span> 7996000659</li>
            </ul>
          </div>
